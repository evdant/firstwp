...
class WPCustomerReviewsAdmin
{
    ...
    function show_options() {
        ...
        <div class="postbox" style="width:700px;">
            ...
            <div id="wpcr_ad">
                ...
                <form method="post" action="">
                    <div style="background:#eaf2fa;padding:6px;border-top:1px solid #ccc;border-bottom:1px solid #ccc;">
                        <legend>Отображение отзовов</legend>
                    </div>
                    <div style="padding:10px;">
                        <label for="show_hcard_on">Отображать отзывы: </label>
                        ...
                        <br />
                        <div class="submit" style="padding:10px 0px 0px 0px;"><input type="submit" class="button-primary" value="Сохранить" name="Submit"></div>
                    </div>
                    <div style="background:#eaf2fa;padding:6px;border-top:1px solid #ccc;border-bottom:1px solid #ccc;">
                    ...
                    <div style="padding:10px;padding-bottom:10px;">
                        ...
                        <br /><br />
                        <input id="support_us" name="support_us" type="checkbox" '.$su_checked.' value="1" />&nbsp;<label for="support_us"><small>Показывать ссылку на плагин под отзывами.</small></label>
                        <br />
                        <div class="submit" style="padding:10px 0px 0px 0px;"><input type="submit" class="button-primary" value="Сохранить" name="Submit"></div>
                    </div>
                    <div style="background:#eaf2fa;padding:6px;border-top:1px solid #ccc;border-bottom:1px solid #ccc;">
                        <legend>Блок отзывов</legend>
                    </div>
                    <div style="padding:10px;padding-bottom:10px;">
                        ...
                        <br /><br />
                        <label for="reviews_per_page">Количество отвывов на странице: </label><input style="width:40px;" type="text" id="reviews_per_page" name="reviews_per_page" value="'.$this->options['reviews_per_page'].'" />
                        <br /><br />
                        <label for="form_location">Форма добавления отзыва: </label>
                        <select id="form_location" name="form_location">
                            <option ';if ($this->options['form_location'] == 0) { echo "selected"; } echo ' value="0">Над отзывами</option>
                            <option ';if ($this->options['form_location'] == 1) { echo "selected"; } echo ' value="1">Под отзывами</option>
                        </select>
                        <br /><br />
                        <label>Поля формы: </label>
                        <input data-what="fname" id="ask_fname" name="ask_fields[]" type="checkbox" '.$af['fname'].' value="fname" />&nbsp;<label for="ask_fname"><small>Имя</small></label>&nbsp;&nbsp;&nbsp;
                        ...
                        <input data-what="fwebsite" id="ask_fwebsite" name="ask_fields[]" type="checkbox" '.$af['fwebsite'].' value="fwebsite" />&nbsp;<label for="ask_fwebsite"><small>Сайт</small></label>&nbsp;&nbsp;&nbsp;
                        <input data-what="ftitle" id="ask_ftitle" name="ask_fields[]" type="checkbox" '.$af['ftitle'].' value="ftitle" />&nbsp;<label for="ask_ftitle"><small>Тема</small></label>
                        <br /><br />
                        <label>Поля формы обязательные для заполнения: </label>
                        <input id="require_fname" name="require_fields[]" type="checkbox" '.$rf['fname'].' value="fname" />&nbsp;<label for="require_fname"><small>Имя</small></label>&nbsp;&nbsp;&nbsp;
                        ...
                        <input id="require_fwebsite" name="require_fields[]" type="checkbox" '.$rf['fwebsite'].' value="fwebsite" />&nbsp;<label for="require_fwebsite"><small>Сайт</small></label>&nbsp;&nbsp;&nbsp;
                        <input id="require_ftitle" name="require_fields[]" type="checkbox" '.$rf['ftitle'].' value="ftitle" />&nbsp;<label for="require_ftitle"><small>Тема</small></label>
                        <br /><br />
                        <label>Поля формы которые потом будут отображаться в отзыве: </label>
                        <input id="show_fname" name="show_fields[]" type="checkbox" '.$sf['fname'].' value="fname" />&nbsp;<label for="show_fname"><small>Имя</small></label>&nbsp;&nbsp;&nbsp;
                        <input id="show_femail" name="show_fields[]" type="checkbox" '.$sf['femail'].' value="femail" />&nbsp;<label for="show_femail"><small>Email</small></label>&nbsp;&nbsp;&nbsp;
                        <input id="show_fwebsite" name="show_fields[]" type="checkbox" '.$sf['fwebsite'].' value="fwebsite" />&nbsp;<label for="show_fwebsite"><small>Сайт</small></label>&nbsp;&nbsp;&nbsp;
                        <input id="show_ftitle" name="show_fields[]" type="checkbox" '.$sf['ftitle'].' value="ftitle" />&nbsp;<label for="show_ftitle"><small>Тема</small></label>
                        <br />
                        <small>It is usually NOT a good idea to show email addresses publicly.</small>
                        <br /><br />
                        <label>Дополнительные поля: </label>(<small>Можно добавтьб дополнительно 6 полей к форме отзывов.</small>)
                        ...
                        for ($i = 0; $i < 6; $i++) /* 6 custom fields */
                        {
                            ...
                            echo '
                            <label for="field_custom'.$i.'">Имя поля: </label><input id="field_custom'.$i.'" name="field_custom['.$i.']" type="text" value="'.$this->options['field_custom'][$i].'" />&nbsp;&nbsp;&nbsp;
                            ...
                            <input '.$crf.' class="custom_req" data-id="'.$i.'" id="require_custom'.$i.'" name="require_custom['.$i.']" type="checkbox" value="1" />&nbsp;<label for="require_custom'.$i.'">Обязательное</label>&nbsp;&nbsp;&nbsp;
                            <input '.$csf.' class="custom_show" data-id="'.$i.'" id="show_custom'.$i.'" name="show_custom['.$i.']" type="checkbox" value="1" />&nbsp;<label for="show_custom'.$i.'">Показывать</label><br />
                            ';
                        }
                        echo '
                        </div>
                        <br /><br />
                        <label for="title_tag">Заголовок отзыва: </label>
                        ...
                        <br /><br />
                        <label for="goto_show_button">Включить форму отзывов: </label><input type="checkbox" id="goto_show_button" name="goto_show_button" value="1" '.$goto_show_button_checked.' />
                        <br />
                        <small>If this option is unchecked, there will be no visible way for visitors to submit reviews.</small>
                        <br /><br />
                        <label for="goto_leave_text">Название кнопки добавления отзыва: </label><input style="width:250px;" type="text" id="goto_leave_text" name="goto_leave_text" value="'.$this->options['goto_leave_text'].'" />
                        <br />
                        <small>This button will be shown above the first review.</small>
                        <br /><br />
                        <label for="leave_text">Название кнопки добавления отзыва: </label><input style="width:250px;" type="text" id="goto_leave_text" name="goto_leave_text" value="'.$this->options['goto_leave_text'].'" />
                        <br />
                        <small>This will be shown as a heading immediately above the review form.</small>
                        <br /><br />
                        <label for="submit_button_text">Название кнопки отправки отзыва: </label><input style="width:200px;" type="text" id="submit_button_text" name="submit_button_text" value="'.$this->options['submit_button_text'].'" />
                        <br />
                        <div class="submit" style="padding:10px 0px 0px 0px;"><input type="submit" class="button-primary" value="Сохранить" name="Submit"></div>
                    </div>
                    <div style="background:#eaf2fa;padding:6px;border-top:1px solid #ccc;border-bottom:1px solid #ccc;">
    ...
    function real_admin_view_reviews() {      
        ...
        <div id="wpcr_respond_1" class="wrap">
            ...
            <h2>Customer Reviews - <?php echo $status_text; ?> Отзывы</h2>
            
              <ul class="subsubsub">
                <li class="all"><a <?php if ($this->p->review_status == -1) { echo 'class="current"'; } ?> href="?page=wpcr_view_reviews&amp;review_status=-1">Все</a> |</li>
                <li class="moderated"><a <?php if ($this->p->review_status == 0) { echo 'class="current"'; } ?> href="?page=wpcr_view_reviews&amp;review_status=0">Ожидают 
                    <span class="count">(<span class="pending-count"><?php echo $pending_count;?></span>)</span></a> |
                </li>
                <li class="approved"><a <?php if ($this->p->review_status == 1) { echo 'class="current"'; } ?> href="?page=wpcr_view_reviews&amp;review_status=1">Размещенные
                    <span class="count">(<span class="pending-count"><?php echo $approved_count;?></span>)</span></a> |
                </li>
                <li class="trash"><a <?php if ($this->p->review_status == 2) { echo 'class="current"'; } ?> href="?page=wpcr_view_reviews&amp;review_status=2">Корзина</a>
              ...
              <form method="GET" action="" id="search-form" name="search-form">
                  <p class="search-box">
                      <?php if ($this->p->s_orig): ?><span style='color:#c00;font-weight:bold;'>Результат поиска: </span><?php endif; ?>
                      <label for="comment-search-input" class="screen-reader-text">Найти:</label> 
              ...
              <div class="tablenav">
                <div class="alignleft actions">
                      <select name="action">
                            <option selected="selected" value="-1">Групповая операция</option>
                            <option value="bunapprove">Отменить утверждение</option>
                            <option value="bapprove">Одобрить</option>
                            <option value="btrash">Удалить в корзину</option>
                      ...
                      <tr class="approved" id="review-<?php echo $rid;?>">
                        ...
                        <td class="comment column-comment">
                          <div class="wpcr-submitted-on">
                            ...
                            <?php if ($review->status == 1) : ?>[<a target="_blank" href="<?php echo $this->parentClass->get_jumplink_for_review($review,$this->page); ?>">Показать на странице</a>]<?php endif; ?>
                          </div>
                          <p>
                              <span style="font-size:13px;font-weight:bold;">Тема отзыва:&nbsp;</span>
                             ...
                             <div style="font-size:13px;font-weight:bold;">
                                 <br />
                                 Ваш Ответ:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 <span style="font-size:11px;font-style:italic;">Оставьте это поле пустым, если Вы не хотите его публиковать</span>
                             </div>
                             <div class="best_in_place" 
                                    data-url='<?php echo $update_path; ?>'
                                    data-object='json'
                          ...
                          <div class="row-actions">
                            <span class="approve <?php if ($review->status == 0 || $review->status == 2) { echo 'wpcr_show'; } else { echo 'wpcr_hide'; }?>"><a title="Одобрить"
                            href="?page=wpcr_view_reviews&amp;action=approvereview&amp;r=<?php echo $rid;?>&amp;review_status=<?php echo $this->p->review_status;?>">
                            Одобрить</a>&nbsp;|&nbsp;</span>
                            <span class="unapprove <?php if ($review->status == 1 || $review->status == 2) { echo 'wpcr_show'; } else { echo 'wpcr_hide'; }?>"><a title="Убрать"
                            href="?page=wpcr_view_reviews&amp;action=unapprovereview&amp;r=<?php echo $rid;?>&amp;review_status=<?php echo $this->p->review_status;?>">
                            Убрать</a><?php if ($review->status != 2): ?>&nbsp;|&nbsp;<?php endif; ?></span>
                            <span class="trash <?php if ($review->status == 2) { echo 'wpcr_hide'; } else { echo 'wpcr_show'; }?>"><a title="В корзину" 
                            href= "?page=wpcr_view_reviews&amp;action=trashreview&amp;r=<?php echo $rid;?>&amp;review_status=<?php echo $this->p->review_status;?>">
                            В корзину</a><?php if ($review->status != 2): ?>&nbsp;|&nbsp;<?php endif; ?></span>
                            <span class="trash <?php if ($review->status == 2) { echo 'wpcr_hide'; } else { echo 'wpcr_show'; }?>"><a title="Удалить навсегда" 
